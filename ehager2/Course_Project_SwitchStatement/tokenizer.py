...
patterns = [
    ...
    [r"switch", "switch"],  #Switch keyword => Course Project addition
    [r"case", "case"],  #Case keyword => Course Project addition
    [r"break", "break"], #Break keyword => Course Project additon
    [r"and", "&&"],  # alternate for &&
    [r"or", "||"],  # alternate for ||
    [r"not", "!"],  # alternate for !
